...
template <> constexpr inline auto AdjustmentCellWidget::qt_create_metaobjectdata<qt_meta_tag_ZN20AdjustmentCellWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(AdjustmentCell *)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
    };
...
void AdjustmentCellWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->removeCellRequested((*reinterpret_cast< std::add_pointer_t<AdjustmentCell*>>(_a[1]))); break;
        case 4: _t->unlinkCellRequested((*reinterpret_cast< std::add_pointer_t<AdjustmentCell*>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (AdjustmentCellWidget::*)(AdjustmentCell * )>(_a, &AdjustmentCellWidget::cellActivated, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (AdjustmentCellWidget::*)(AdjustmentCell * )>(_a, &AdjustmentCellWidget::removeCellRequested, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (AdjustmentCellWidget::*)(AdjustmentCell * )>(_a, &AdjustmentCellWidget::unlinkCellRequested, 4))
            return;
    }
}
