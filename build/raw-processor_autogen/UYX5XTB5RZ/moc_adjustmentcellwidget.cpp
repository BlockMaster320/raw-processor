...
void AdjustmentCellWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->removeCellRequested((*reinterpret_cast< std::add_pointer_t<AdjustmentCell*>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AdjustmentCellWidget::*)()>(_a, &AdjustmentCellWidget::adjustmentChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AdjustmentCellWidget::*)(AdjustmentCell * )>(_a, &AdjustmentCellWidget::removeCellRequested, 1))
            return;
    }
}
