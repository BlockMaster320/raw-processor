...
namespace {
struct qt_meta_tag_ZN13GalleryWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto GalleryWidget::qt_create_metaobjectdata<qt_meta_tag_ZN13GalleryWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<GalleryWidget, qt_meta_tag_ZN13GalleryWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject GalleryWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13GalleryWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13GalleryWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13GalleryWidgetE_t>.metaTypes,
    nullptr
} };
...
void *GalleryWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13GalleryWidgetE_t>.strings))
